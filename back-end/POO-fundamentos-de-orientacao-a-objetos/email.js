"use strict";
class Email {
    constructor(de, para, mensagem, assunto) {
        this._de = de;
        this._para = para;
...
personalMailList.pegarRemetente(myEmail).forEach((mail) => console.log(mail.conteudo));
...
personalMailList.pesquisaNoAssunto('Day off').forEach((mail) => console.log(mail.conteudo));
personalMailList.removeEmail(email5);
console.log('------ professionalMailList.todosEmails:');
professionalMailList.todosEmails.forEach((mail) => console.log(mail.conteudo));
console.log('------ personalMailList.todosEmails:');
personalMailList.todosEmails.forEach((mail) => console.log(mail.conteudo));
